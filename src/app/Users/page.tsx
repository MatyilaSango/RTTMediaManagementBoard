...
export default function Users() {
  ...
  useEffect(() => {
    ...
    axios.get("https://rrt-media-server-api.vercel.app/api/v1/users", { signal: signal, withCredentials: true })
      .then(data => data.data)
      .then(data => {
  ...
  const handleNewUserForm = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = (await axios.post("https://rrt-media-server-api.vercel.app/api/v1/users/post-new-user", formData, {withCredentials: true})).data
